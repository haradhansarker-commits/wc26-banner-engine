...
def flag_canada():
    return ('<rect width="100" height="66.667" fill="#FF0000"/>'
            ...
            '<path d="M50.0,11.0 L51.4,19.0 L56.2,17.6 L54.4,22.2 L61.0,21.4 L58.6,25.8 '
            'L65.4,28.2 L56.2,30.0 L58.0,35.0 L52.0,33.4 L53.8,41.8 L50.7,39.0 L51.7,47.8 '
            'L53.6,48.6 L50.0,48.6 L46.4,48.6 L48.3,47.8 L49.3,39.0 L46.2,41.8 L48.0,33.4 '
            'L42.0,35.0 L43.8,30.0 L34.6,28.2 L41.4,25.8 L39.0,21.4 L45.6,22.2 L43.8,17.6 '
            'L48.6,19.0 L50.0,11.0 Z" fill="#FF0000"/>')
